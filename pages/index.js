      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        ...
        <section>
            ...
            <div className="stratpoint flex justify-between my-4">
              ...
              <div className="basis-1/2">
                <div className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
                  <h4 className="text-2xl py-1 dark:text-white font-bold">Stratpoint Technologies Inc. </h4>
                  <h4 className="text-xl py-1 dark:text-white font-bold">May 2021-Present </h4>
                  <h4 className="text-l py-1 dark:text-white font-bold">Project: </h4>
                  Aetos - A web app for employee meeting records. <br />
                  <h4 className="text-l py-1 dark:text-white font-bold">Role: </h4>
                  Frontend/Backend Developer
                  <h4 className="text-l py-1 dark:text-white font-bold">Frameworks/Languages Used: </h4>
          ...
          <div className="skills-and-character my-8">
            <h3 className="text-3xl py-1 dark:text-white ">Skills and Character</h3>
            <hr class="my-4 h-px bg-gray-200 border-2 dark:bg-gray-700"></hr>
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
